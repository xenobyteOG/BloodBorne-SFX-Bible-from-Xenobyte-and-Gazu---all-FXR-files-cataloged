...
One thing that does usually hold true is boss SFXs are in the 600000 range. For instance if you want to move a boss from one map to another then look in the original map's SFX DC archive in the f000600000-f000700000 range to find the boss special effects. Take them and then add them to the map SFX DCX you are adding the boss to. That way you have the full SFX of the boss on the new map. 
